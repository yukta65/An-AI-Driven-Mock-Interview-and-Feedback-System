...
function QuestionSection({ mockInterviewQuestions, activeQuestionIndex }) {
  ...
  return mockInterviewQuestions&&(
    <div className="p-5 border rounded-lg my-10">
      ...
      <Volume2 className='cursor-pointer' onClick={()=>{testToSpeach(mockInterviewQuestions[activeQuestionIndex]?.question)}}/>
      <div className='border rounded-lg p-5 bg-purple-100 mt-20'>
